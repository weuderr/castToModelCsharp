...
alter table "SindicatosHomologacoesRegiao"
    owner to postgres;

create index "IX_SindicatosHomologacoesRegiao_HomologacoesRegiaoId"
    on "SindicatosHomologacoesRegiao" using ??? ("HomologacoesRegiaoId");
...
create index "IX_Participantes_IdDadosBancarios"
    on "Participantes" using ??? ("IdDadosBancarios");

create index "IX_Participantes_IdEndereco"
    on "Participantes" using ??? ("IdEndereco");

create index "IX_Participantes_IdSindicato"
    on "Participantes" using ??? ("IdSindicato");
...
alter table "HomologacoesCobrancas"
    owner to postgres;

create index "IX_HomologacoesCobrancas_IdSindicato"
    on "HomologacoesCobrancas" using ??? ("IdSindicato");

create index "IX_HomologacoesCobrancas_IdParticipante"
    on "HomologacoesCobrancas" using ??? ("IdParticipante");

create index "IX_HomologacoesCobrancas_IdHomologacao"
    on "HomologacoesCobrancas" using ??? ("IdHomologacao");
...
alter table "HomologacoesDocumentos"
    owner to postgres;

create index "IX_HomologacoesDocumentos_IdSindicato"
    on "HomologacoesDocumentos" using ??? ("IdSindicato");

create index "IX_HomologacoesDocumentos_IdParticipante"
    on "HomologacoesDocumentos" using ??? ("IdParticipante");

create index "IX_HomologacoesDocumentos_IdHomologacao"
    on "HomologacoesDocumentos" using ??? ("IdHomologacao");
...
alter table "HomologacoesParticipantes"
    owner to postgres;

create index "IX_HomologacoesParticipantes_IdHomologacao"
    on "HomologacoesParticipantes" using ??? ("IdHomologacao");

create index "IX_HomologacoesParticipantes_IdParticipante"
    on "HomologacoesParticipantes" using ??? ("IdParticipante");

create index "IX_HomologacoesParticipantes_IdSindicato"
    on "HomologacoesParticipantes" using ??? ("IdSindicato");
